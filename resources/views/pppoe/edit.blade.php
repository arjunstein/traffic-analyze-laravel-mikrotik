                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="password" class="form-control"
                                    value="{{ $user['password'] ?? '' }}" id="password" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="localaddress" value="{{ $user['local-address'] ?? '' }}"
                                    class="form-control" id="timelimit">
                            </div>
                            <div class="form-group">
                                <label for="comment">Remote Address</label>
                                <input type="text" name="remoteaddress" class="form-control"
                                    value="{{ $user['remote-address'] ?? '' }}" id="comment">
                            </div>
                            <div class="form-group">
